...
return [
    ...
    | classe de validação. Algumas dessas regras têm múltiplas versões,
    | como as regras de tamanho. Sinta-se livre para ajustar cada uma
    ...
    */
    ...
    | Isso facilita a definição de uma mensagem específica para uma dada
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Nomes amigáveis para os atributos personalizados
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para trocar o placeholder do atributo
    | por algo mais amigável ao leitor, como "Endereço de E-mail" em vez
    | de "email". Isso ajuda a tornar nossas mensagens mais expressivas.
    |
    */
